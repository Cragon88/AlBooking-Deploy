  ...
  apply: {
    ...
    process: {
      ...
      rounds: [
        ...
        {name: "Round 1 (Written Application)", time: "19/08/17 - 19/09/17      20/11/17 - 04/01/18"},
        {name: "Round 2 (SEO-V Interview)", time: "09/10/17 - 30/10/17      21/01/18 - 18/02/18"},
        {name: "Round 3 (Employer Interview)", time: "13/11/17 - mid Dec 17   02/03/18 - early Apr 18"},
